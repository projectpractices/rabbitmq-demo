...
public class RecivedTopic003 {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             * param2:交换机名称
             */
            channel.queueBind(QUEUE_INFORM_SMS, EXCHANGE_TOPIC_INFORM, "inform.*.sms.email");
            channel.queueBind(QUEUE_INFORM_EMAIL, EXCHANGE_TOPIC_INFORM, "inform.*.email.sms");
